export const BASE_URL =
  "https://myhealthbuddy-api.edmingle.com/nuSource/api/v1";

export const INSTITUTE_ID = 3835;
export const PER_PAGE = 25;
// export const SUBJECT_FILTER_ID = 15;
export const LEVEL_FILTER_ID = 381;
// export const TYPE_FILTER_ID = 14;
// export const ASSESSMENT_FILTER_ID = 13;
// export const DURATION_FILTER_ID = 12;
// export const INCLUSION_FILTER_ID = 11;
export const CUSTOM_CREDITS = 383;
export const CUSTOM_DURATION = 384;
// export const CUSTOM_QUIZ = 10;
export const CUSTOM_WHAT_LEARN = 382;
// export const CUSTOM_ELIGIBILITY = 3;
// export const CUSTOM_FAQ = 4;
// export const CUSTOM_INCLUSION = 5;
// export const CUSTOM_IS_SAMPLE = 6;
// export const CUSTOM_SAMPLE_PDF = 7;
export const CUSTOM_ACC = 385;
